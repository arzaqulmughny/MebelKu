  ...
  return (
    <>
      <div className="flex flex-col bg-white">
        <ul className="border-t border-(--border) py-5 px-2.5 flex flex-wrap gap-7">
          ...
          <li className="flex flex-col gap-y-2">
            ...
            <ul className="flex flex-col gap-y-2">
              <li>
                <a href="/about" className="text-(--text-light)/70 text-sm">
                  Tentang Kami
                </a>
              </li>
              <li>
          ...
          <li className="flex flex-col gap-y-2 flex-1">
            ...
            <ul className="flex flex-col gap-y-2">
              <li>
                <a
                  href="/about"
                  className="text-(--text-light)/70 text-sm flex items-center gap-x-2"
                >
                  <div className="w-4 aspect-video text-(--primary)">
                    <svg
        ...
        <p className="text-center text-sm text-(--primary) border-t border-(--border-light) py-4 mx-5">
          &copy; 2025 MebelKu. All rights reserved.
        </p>
      </div>
    </>
  );
