...
const ButtonIcon = ({ children }: ButtonIconProps) => {
  return (
    <button
      type="button"
      className="text-(--text-light) w-8 aspect-square flex items-center justify-center rounded-full cursor-pointer [&>svg]:w-4"
    >
      {children}
    </button>
  );
...
export default function Navbar() {
  return (
    <nav className="border-b border-(--border-color) px-4 py-2 sticky top-0 bg-white z-10 flex flex-col gap-y-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-x-1">
          ...
          <h1 className="text-(--text-light) font-bold text-md md:inline">
            MebelKu
          </h1>
        </div>

        <div className="min-w-[500px] hidden md:inline">
          <Searchbar />
        </div>
